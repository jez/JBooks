...
public class Transaction implements Comparable<Transaction>, Serializable
{
	...
	/**
	 * Water plants over vacation
	 */
	public static final int WATER_PLANTS = 3;
	/**
	 * Spread mulch ($10/ cu. yd)
	 */
	public static final int SPREAD_MULCH = 4;
	/**
	...
	public static int parseType(String option)
	{
		...
		else if(option.equals("Water plants"))
			return WATER_PLANTS;
	...
	public String getXML()
	{
		...
		result += "<transaction>\n";
		result += "\t<type>" + typeStr + "</type>\n";
		result += "\t<startDate>" + sdfmt.format(startDate.getTime()) + "</startDate>\n";
		try
		{
			result += "\t<endDate>" + sdfmt.format(endDate.getTime()) + "</endDate>\n";
		}
		catch(NullPointerException npe)
		{
			result += "\t<endDate></endDate>\n";
		}
		result += "\t<moneyReceived>" + nfmt.format(moneyReceived) + "</moneyReceived>\n";
		result += "\t<moneyPending>" + nfmt.format(moneyPending) + "</moneyPending>\n";
		result += "</transaction>\n";
