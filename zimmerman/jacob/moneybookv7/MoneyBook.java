...
public class MoneyBook
{
	...
	public MoneyBook()
	{
		...
		menu.add(menuItem);
		menuItem = new JMenuItem("Save As...", new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("images/Money Book.gif"))));
		menuItem.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent me){
				JFileChooser fc = new JFileChooser(".");
	...
	public void save()
	{
		...
		try
		{
			rootElementName = file.getName().substring(0, file.getName().indexOf("."));
	...
	public class CustomersPanel
	{
		...
		public CustomersPanel(CustomerPanel customerPanel)
		{
			...
			openButton = new JButton("Open file", new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("images/Open.gif"))));
		...
		class AddNewCustomer implements ActionListener
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				if(customerName != null)
				{
					...
					System.out.println(customer.getXML());
